...
export const ICONS = {
  ...
  image: I('<rect x="3" y="4" width="18" height="16" rx="2"/><circle cx="8.5" cy="9.5" r="1.6"/><path d="m21 16-5-5-8 8"/>'),
  tasbih: I('<circle cx="12" cy="4" r="1.7"/><circle cx="17.7" cy="6.3" r="1.7"/><circle cx="20" cy="12" r="1.7"/><circle cx="17.7" cy="17.7" r="1.7"/><circle cx="12" cy="20" r="1.7"/><circle cx="6.3" cy="17.7" r="1.7"/><circle cx="4" cy="12" r="1.7"/><circle cx="6.3" cy="6.3" r="1.7"/>'),
