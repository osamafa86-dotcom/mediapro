...
export function mount(container, app) {
  ...
  function build() {
    ...
    render(container,
      ...
      h('p', { class: 'tiny', style: { textAlign: 'center', marginTop: '8px' } }, `سكينة ${app.version}${app.build ? ` (بناء ${app.build})` : ''} · يعمل دون اتصال · لا حساب ولا تتبّع؛ الشبكة تُستخدم فقط لجلب التلاوات والتفاسير وخطوط المصحف، ولتسمية مدينتك بإحداثيات مقرّبة (يمكن إيقافها من الإعدادات)`));
  }
